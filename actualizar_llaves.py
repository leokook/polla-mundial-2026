...
if __name__ == "__main__":
    ...
    #actualizar_partido(78, "yyyyy", "xxx")
    #actualizar_partido(77, "yyyyye", "xxx")
    #actualizar_partido(79, "yyyyye", "xxx")
    #actualizar_partido(80, "yyyyy", "xxx")
    #actualizar_partido(82, "yyyyy", "xxx")
    #actualizar_partido(83, "yyyyy", "xxx")
    #actualizar_partido(84, "yyyyy", "xxx")
    #actualizar_partido(86, "yyyyy", "xxx")
